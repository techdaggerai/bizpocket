        ...
        {data.bank_name && (
          <div className="border-t border-[#E5E5E5] pt-4 mb-4">
            ...
            <div className="text-xs text-[#666] space-y-0.5">
              ...
              {data.bank_account_name && <p>{data.bank_account_name} \u00B7 {data.bank_account_number}</p>}
            </div>
          </div>
        )}
        ...
        {data.bank_name && (
          <div className="border border-[#E5E5E5] rounded p-3 mb-4">
            ...
            <div className="text-xs text-[#0A0A0A] space-y-0.5">
              <p>{data.bank_name} {data.bank_branch}</p>
      ...
      <div className="px-6 py-4">
        ...
        {data.bank_name && (
          <div className="text-[10px] text-[#999] border-t border-[#F5F5F5] pt-2">
            Pay to: {data.bank_name} {data.bank_branch && `(${data.bank_branch})`} &middot; {data.bank_account_name} &middot; {data.bank_account_number}
          </div>
        )}
