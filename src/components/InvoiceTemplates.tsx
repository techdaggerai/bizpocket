...
function BoldTemplate({ data }: { data: InvoiceData }) {
  return (
    <div className="bg-[#0A0A0A] text-white w-full max-w-[210mm] mx-auto" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      <div className="px-8 py-6">
        <div className="flex justify-between items-center mb-8"><h1 className="text-2xl font-black text-white">{data.company_name}</h1><div className="bg-[#FACC15] text-white px-4 py-1.5"><p className="text-sm font-black uppercase tracking-wider">Invoice</p></div></div>
