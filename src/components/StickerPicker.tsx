  ...
  return (
    <>
      ...
      <div className="fixed bottom-16 left-0 right-0 z-50 mx-auto max-w-md">
        <div className="mx-3 rounded-2xl bg-white shadow-2xl border border-[#E5E5E5] overflow-hidden">

          {/* Pack tabs */}
          <div className="flex border-b border-[#F0F0F0] bg-[#F9FAFB]">
            {PACKS.map((p, i) => (
              <button
                key={p.id}
                ...
                className={`flex flex-1 flex-col items-center gap-1 py-2.5 transition-colors ${
                  activePack === i
                    ? 'border-b-2 border-[#4F46E5] bg-white text-[#4F46E5]'
            ...
            <button
              onClick={onClose}
              className="px-3 text-[#9CA3AF] hover:text-[#374151] transition-colors"
              aria-label="Close"
            >
          ...
          {/* Footer hint */}
          <div className="border-t border-[#F0F0F0] px-4 py-2 text-center">
