    ...
    <>
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute inset-0 flex flex-col items-center justify-center bg-white/60 rounded-[14px] cursor-pointer transition-all hover:bg-white/70"
        >
          ...
          <p className="text-sm font-semibold text-[#0A0A0A]">{feature}</p>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl max-w-sm w-full mx-4 p-6 text-center">
            ...
            <h3 className="text-lg font-bold text-[#0A0A0A] mb-1">Unlock {feature}</h3>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 rounded-xl border border-[#E5E5E5] py-3 text-sm font-medium text-[#6B7280] hover:bg-[#F9FAFB] transition-colors"
              >
                Maybe Later
              </button>
              <Link
