  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '60px 24px', fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div style={section}>
        ...
        <p style={p}>By accessing or using BizPocket and Evrywher, you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use our services. We may update these terms from time to time, and continued use constitutes acceptance of any changes.</p>
      </div>

      <div style={section}>
        <h2 style={h2}>Description of Service</h2>
        <p style={p}>BizPocket is a mobile-first business management platform designed for foreigners running businesses in Japan. Evrywher is our built-in multilingual messenger with real-time AI translation. Together, they provide invoicing, cash flow tracking, expense management, document storage, AI-powered business insights, and translated communication across 21 languages.</p>
      </div>
