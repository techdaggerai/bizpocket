    ...
    <div className="space-y-6 p-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-2">
          <Link
            href="/invoices?new=1"
            className="flex flex-col items-center gap-2.5 rounded-[12px] bg-[rgba(79,70,229,0.08)] p-4 text-center transition-all hover:bg-[rgba(79,70,229,0.12)]"
          >
            ...
            <span className="text-[11px] font-medium text-[#4F46E5]">Fire Invoice</span>
          </Link>
          <Link
            href="/cash-flow?new=1"
            className="flex flex-col items-center gap-2.5 rounded-[12px] bg-[rgba(22,163,74,0.08)] p-4 text-center transition-all hover:bg-[rgba(22,163,74,0.12)]"
          >
            <svg className="h-5 w-5 text-[#16A34A]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
            </svg>
            <span className="text-[11px] font-medium text-[#16A34A]">Log It</span>
          </Link>
          <Link
            href="/detect"
            className="flex flex-col items-center gap-2.5 rounded-[12px] bg-[rgba(14,165,233,0.08)] p-4 text-center transition-all hover:bg-[rgba(14,165,233,0.12)]"
          >
            <svg className="h-5 w-5 text-[#0EA5E9]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />
            </svg>
            <span className="text-[11px] font-medium text-[#0EA5E9]">AI Detect</span>
          </Link>
          <Link
            href="/chat"
            className="flex flex-col items-center gap-2.5 rounded-[12px] bg-[rgba(124,58,237,0.08)] p-4 text-center transition-all hover:bg-[rgba(124,58,237,0.12)]"
          >
            <svg className="h-5 w-5 text-[#7C3AED]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
            </svg>
            <span className="text-[11px] font-medium text-[#7C3AED]">PocketChat</span>
          </Link>
          <Link
            href="/expenses"
            className="flex flex-col items-center gap-2.5 rounded-[12px] bg-[rgba(239,68,68,0.08)] p-4 text-center transition-all hover:bg-[rgba(239,68,68,0.12)]"
          >
            <svg className="h-5 w-5 text-[#EF4444]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
            </svg>
            <span className="text-[11px] font-medium text-[#EF4444]">Expenses</span>
          </Link>
          <Link
            href="/documents"
            className="flex flex-col items-center gap-2.5 rounded-[12px] bg-[rgba(20,184,166,0.08)] p-4 text-center transition-all hover:bg-[rgba(20,184,166,0.12)]"
          >
            <svg className="h-5 w-5 text-[#14B8A6]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Z" />
            </svg>
            <span className="text-[11px] font-medium text-[#14B8A6]">Snap & Vault</span>
          </Link>
          <Link
            href="/planner"
            className="flex flex-col items-center gap-2.5 rounded-[12px] bg-[rgba(236,72,153,0.08)] p-4 text-center transition-all hover:bg-[rgba(236,72,153,0.12)]"
          >
            <svg className="h-5 w-5 text-[#EC4899]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
            </svg>
            <span className="text-[11px] font-medium text-[#EC4899]">Planner</span>
          </Link>
          <Link
            href="/contacts"
            className="flex flex-col items-center gap-2.5 rounded-[12px] bg-[rgba(245,158,11,0.08)] p-4 text-center transition-all hover:bg-[rgba(245,158,11,0.12)]"
          >
            <svg className="h-5 w-5 text-[#F59E0B]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
            </svg>
            <span className="text-[11px] font-medium text-[#F59E0B]">Contacts</span>
          </Link>
        </div>
      </div>
