...
export default function LiveConversationPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-slate-900 flex flex-col items-center justify-center px-6">
      ...
      <h1 className="text-xl font-bold text-white mb-1">Live Conversation</h1>
      <p className="text-sm text-slate-400 text-center mb-6">Two-way real-time translation</p>
