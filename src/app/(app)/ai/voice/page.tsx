...
export default function VoiceTranslatePage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-slate-900 flex flex-col items-center justify-center px-6">
      <div className="w-16 h-16 rounded-2xl bg-amber-600 flex items-center justify-center mb-4">
        <Mic size={28} className="text-white" />
      </div>
      <h1 className="text-xl font-bold text-white mb-1">Voice Translate</h1>
      <p className="text-sm text-slate-400 text-center mb-6">Speak and hear translations</p>
