...
export default function CameraTranslatePage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-slate-900 flex flex-col items-center justify-center px-6">
      ...
      <h1 className="text-xl font-bold text-white mb-1">Camera Translate</h1>
      <p className="text-sm text-slate-400 text-center mb-6">Point, snap, translated instantly</p>
