          ...
          {detecting && (
            <div className="rounded-xl border border-slate-700 bg-slate-800 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-sm font-medium text-indigo-400">AI is analyzing your document...</span>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-800 p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-indigo-400">AI DETECTED</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="rounded-xl border border-[rgba(79,70,229,0.15)] bg-[rgba(79,70,229,0.03)] p-4">
                <div className="flex items-center gap-1.5 mb-2">
                  ...
                  <span className="text-[10px] font-semibold text-indigo-400">TRANSLATION</span>
                </div>
              ...
              <button onClick={() => setShowContactPicker(!showContactPicker)}
                className="w-full flex items-center justify-center gap-2 rounded-xl border border-[#4F46E5]/20 bg-[#4F46E5]/5 py-3 text-sm font-medium text-indigo-400 transition-colors hover:bg-[#4F46E5]/10">
