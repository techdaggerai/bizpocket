    ...
    <>
      ...
      <div className="flex gap-6 py-4 -mx-4 lg:-mx-8 px-4 lg:px-8">
        ...
        <div className="flex-1 min-w-0 space-y-4 lg:max-w-[580px]">
          ...
          {/* Actions */}
          <div className="flex gap-2">
            <button onClick={handleDownloadPDF} className="flex-1 rounded-xl border border-[#E5E5E5] py-3 text-sm font-medium text-[#666] hover:bg-[#FAFAFA]">Download PDF</button>
            <button onClick={handleShare} className="flex-1 rounded-xl border border-[#4F46E5]/20 bg-[#4F46E5]/5 py-3 text-sm font-medium text-[#4F46E5] hover:bg-[#4F46E5]/10">Share</button>
          </div>
          <div className="flex gap-2">
