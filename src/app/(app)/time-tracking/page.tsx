...
export default function TimeTrackingPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      : entries.length === 0 ? <div className="rounded-xl border border-dashed border-slate-700 p-8 text-center"><p className="text-sm text-[#999]">No time entries yet</p></div>
