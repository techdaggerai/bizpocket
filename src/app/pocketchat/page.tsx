        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
          {[
            ...
            <div key={i} style={{ background: '#141414', borderRadius: 20, border: '1px solid #222', padding: 28, position: 'relative', overflow: 'hidden' }}>
              {f.badge && <div style={{ position: 'absolute', top: 12, right: 12, background: '#22c55e', color: 'white', fontSize: 10, fontWeight: 700, padding: '3px 8px', borderRadius: 100 }}>{f.badge}</div>}
